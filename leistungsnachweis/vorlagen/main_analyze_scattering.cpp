...
// unser Updater für die Streufunktion
#include "AnalyzerScattering.h"
...
int main(int argc, char* argv[])
{
  ...
  desc.add_options()
    ...
    ("ofile,o", value<std::string>(&outFileName)->default_value("scattering.dat"), "result filename");
  ...
  // unser scattering analyzer
  taskManager.addAnalyzer(new AnalyzerScattering<IngredientsType>(ingredients,outFileName));
