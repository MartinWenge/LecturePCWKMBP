...
int main(int argc, char* argv[])
{
  ...
  desc.add_options()
    ("help,h", "help message")
    ("ifile,i", value<std::string>(&inFileName)->default_value("chainConfig.bfm"), "input filename")
    ("ofile,o", value<std::string>(&outFileName)->default_value("chainConfig_sim.dat"), "output filename")
  ...
  /* +++++++++++++++++++++++++  setup system  +++++++++++++++++++++++++++++++ */
  typedef LOKI_TYPELIST_3(FeatureMoleculesIO,FeatureAttributes,FeatureAdsorption) Features;
  //typedef LOKI_TYPELIST_4(FeatureMoleculesIO,FeatureAttributes,FeatureExcludedVolumeSc<FeatureLattice<bool> >, FeatureAdsorption) Features;
